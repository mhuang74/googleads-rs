...
use googleads_rs::current_gads_version::resources::conversion_action::ValueSettings;
...
fn test_conversion_action_status() {
    use googleads_rs::current_gads_version::enums::conversion_action_status_enum::ConversionActionStatus;
...
fn test_conversion_action_type() {
    use googleads_rs::current_gads_version::enums::conversion_action_type_enum::ConversionActionType;
...
fn test_conversion_action_category() {
    use googleads_rs::current_gads_version::enums::conversion_action_category_enum::ConversionActionCategory;
...
#[test]
fn test_asset_type() {
    use googleads_rs::current_gads_version::enums::asset_type_enum::AssetType;
...
fn test_asset_policy_summary_approval_status() {
    use googleads_rs::current_gads_version::enums::policy_approval_status_enum::PolicyApprovalStatus;
    use googleads_rs::current_gads_version::resources::AssetPolicySummary;
...
fn test_asset_policy_summary_review_status() {
    use googleads_rs::current_gads_version::enums::policy_review_status_enum::PolicyReviewStatus;
    use googleads_rs::current_gads_version::resources::AssetPolicySummary;
...
fn test_ad_group_asset_primary_status() {
    use googleads_rs::current_gads_version::enums::asset_link_primary_status_enum::AssetLinkPrimaryStatus;
...
fn test_user_list_membership_status() {
    use googleads_rs::current_gads_version::enums::user_list_membership_status_enum::UserListMembershipStatus;
...
fn test_user_list_size_range_for_display() {
    use googleads_rs::current_gads_version::enums::user_list_size_range_enum::UserListSizeRange;
...
fn test_user_list_type() {
    use googleads_rs::current_gads_version::enums::user_list_type_enum::UserListType;
