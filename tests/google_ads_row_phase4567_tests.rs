...
use googleads_rs::current_gads_version::common::{ClickLocation, Metrics, Segments};
...
fn test_geographic_view_location_type() {
    use googleads_rs::current_gads_version::enums::geo_targeting_type_enum::GeoTargetingType;
...
fn test_asset_group_asset_field_type() {
    use googleads_rs::current_gads_version::enums::asset_field_type_enum::AssetFieldType;
...
fn test_asset_group_asset_status() {
    use googleads_rs::current_gads_version::enums::asset_link_status_enum::AssetLinkStatus;
...
//     use googleads_rs::current_gads_version::enums::asset_performance_label_enum::AssetPerformanceLabel;
...
fn test_recommendation_type() {
    use googleads_rs::current_gads_version::enums::recommendation_type_enum::RecommendationType;
...
fn test_recommendation_impact_metrics() {
    use googleads_rs::current_gads_version::resources::recommendation::{
...
fn test_shared_set_all_fields() {
    use googleads_rs::current_gads_version::enums::shared_set_status_enum::SharedSetStatus;
    use googleads_rs::current_gads_version::enums::shared_set_type_enum::SharedSetType;
...
fn test_shared_criterion_keyword() {
    use googleads_rs::current_gads_version::common::KeywordInfo;
    use googleads_rs::current_gads_version::enums::criterion_type_enum::CriterionType;
    use googleads_rs::current_gads_version::resources::shared_criterion::Criterion;
...
fn test_campaign_shared_set_all_fields() {
    use googleads_rs::current_gads_version::enums::campaign_shared_set_status_enum::CampaignSharedSetStatus;
...
fn test_interaction_event_types() {
    use googleads_rs::current_gads_version::enums::interaction_event_type_enum::InteractionEventType;
...
fn test_product_segments_attributes() {
    use googleads_rs::current_gads_version::enums::product_condition_enum::ProductCondition;
...
fn test_hotel_segments() {
    use googleads_rs::current_gads_version::enums::day_of_week_enum::DayOfWeek;
    use googleads_rs::current_gads_version::enums::hotel_date_selection_type_enum::HotelDateSelectionType;
    use googleads_rs::current_gads_version::enums::hotel_price_bucket_enum::HotelPriceBucket;
    use googleads_rs::current_gads_version::enums::hotel_rate_type_enum::HotelRateType;
...
fn test_sk_ad_network_segments() {
    use googleads_rs::current_gads_version::enums::sk_ad_network_ad_event_type_enum::SkAdNetworkAdEventType;
    use googleads_rs::current_gads_version::enums::sk_ad_network_attribution_credit_enum::SkAdNetworkAttributionCredit;
    use googleads_rs::current_gads_version::enums::sk_ad_network_coarse_conversion_value_enum::SkAdNetworkCoarseConversionValue;
    use googleads_rs::current_gads_version::enums::sk_ad_network_source_type_enum::SkAdNetworkSourceType;
    use googleads_rs::current_gads_version::enums::sk_ad_network_user_type_enum::SkAdNetworkUserType;
