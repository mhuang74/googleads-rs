...
fn test_account_budget_status() {
    use googleads_rs::current_gads_version::enums::account_budget_status_enum::AccountBudgetStatus;
...
fn test_asset_group_status() {
    use googleads_rs::current_gads_version::enums::asset_group_status_enum::AssetGroupStatus;
...
fn test_asset_group_ad_strength() {
    use googleads_rs::current_gads_version::enums::ad_strength_enum::AdStrength;
...
fn test_audience_status() {
    use googleads_rs::current_gads_version::enums::audience_status_enum::AudienceStatus;
...
fn test_bidding_strategy_status() {
    use googleads_rs::current_gads_version::enums::bidding_strategy_status_enum::BiddingStrategyStatus;
...
fn test_label_status() {
    use googleads_rs::current_gads_version::enums::label_status_enum::LabelStatus;
...
fn test_customer_client_status() {
    use googleads_rs::current_gads_version::enums::customer_status_enum::CustomerStatus;
...
fn test_search_term_view_status() {
    use googleads_rs::current_gads_version::enums::search_term_targeting_status_enum::SearchTermTargetingStatus;
...
fn test_change_event_change_resource_type() {
    use googleads_rs::current_gads_version::enums::change_event_resource_type_enum::ChangeEventResourceType;
...
fn test_change_event_client_type() {
    use googleads_rs::current_gads_version::enums::change_client_type_enum::ChangeClientType;
...
fn test_change_event_resource_change_operation() {
    use googleads_rs::current_gads_version::enums::resource_change_operation_enum::ResourceChangeOperation;
...
fn test_ad_group_ad_asset_view_pinned_field() {
    use googleads_rs::current_gads_version::enums::served_asset_field_type_enum::ServedAssetFieldType;
