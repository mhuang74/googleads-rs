...
#![doc(html_root_url = "https://docs.rs/googleads-rs/24.2.0")]
...
pub use google::ads::googleads::v24 as current_gads_version;
...
impl DynamicMutationBuilder {
    ...
    pub fn build(
        &self,
        resource_name: &str,
    ) -> anyhow::Result<current_gads_version::services::MutateGoogleAdsRequest> {
        ...
        let static_request = request
            .transcode_to::<current_gads_version::services::MutateGoogleAdsRequest>()
